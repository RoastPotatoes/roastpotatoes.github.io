...
#### Prerequisites
* First I recommend to install git so you can easily clone the repository. This is easy to do on windows just go to this link: 	http://git-scm.com/downloads and download the windows installer.
